		...
		<div class="col-md-4"></div>
			<div class="col-md-4">
				<section class="login-form">
					<form:form  commandName="customer" action="${pageContext.request.contextPath}/order/updateCustomer" method="post" role="login" class="form-horizontal">
			 ...
			 <!--    <input id="answerIsYes" type="radio" name="answer" value="Yes"> Yes <input type="radio" id="answerIsNo" name="answer" value="No"> No<br>--> 
				...
				<button class="btn btn-default" name="_eventId_save">Save</button>
