Feature: Registeration  Functionality
  ...
  Scenario Outline: Successfully Register a user
    ...
    Examples: 
      ...
      | NAeki5211 |  | password |  | ck@gmail.com |  | myPassword     |  |                90 |  | carling             |  | ottawa      |  | on              |  | Canada         |  | k1g3r4         |
      | SAA625l |  | password |  | ck@gmail.com |  | myPassword     |  |                90 |  | carling             |  | ottawa      |  | on              |  | Canada         |  | k1g3r4         |
